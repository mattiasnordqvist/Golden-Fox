    ...
    public class ScheduleTests
    {
        ...
        public void EveryDayAt0630FromSameTimeIncludeNow()
        {
            Assert.AreEqual(
                ...
                new Schedule
                    {
                        AtTimes = new List<Clock> { new Clock { Hour = 6, Minute = 30 } },
        ...
        public void EveryDayAtTwoTimesBothLaterSameDay()
        {
            Assert.AreEqual(
                ...
                new Schedule
                {
                    AtTimes = new List<Clock> { new Clock { Hour = 7, Minute = 30 }, new Clock { Hour = 8, Minute = 30 } },
                    Interval = Interval.Day,
                    DaysOffset = 0
                }.Next(new DateTime(2015, 10, 05, 6, 30, 0)));
        }
        ...
        public void EveryDayAtTwoTimesOneLaterSameDayOneEarlierNextDay()
        {
            Assert.AreEqual(
                ...
                new Schedule
                {
                    AtTimes = new List<Clock> { new Clock { Hour = 5, Minute = 30 }, new Clock { Hour = 8, Minute = 30 } },
                    Interval = Interval.Day,
                    DaysOffset = 0
                }.Next(new DateTime(2015, 10, 05, 6, 30, 0)));
        }
