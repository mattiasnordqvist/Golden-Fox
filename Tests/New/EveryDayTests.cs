    ...
    public class EveryDayTests
    {
        ...
        public void EveryDayAt0630FromSameTimeIncludeNow()
        {
            Assert.AreEqual(
                ...
                new Schedule(new List<Clock> { new Clock { Hour = 6, Minute = 30 } }, 0, Interval.Day)
        ...
        public void EveryDayAtTwoTimesBothLaterSameDay()
        {
            Assert.AreEqual(
                ...
                new Schedule(new List<Clock> { new Clock { Hour = 7, Minute = 30 }, new Clock { Hour = 8, Minute = 30 } }, 0, Interval.Day)
                .Next(new DateTime(2015, 10, 05, 6, 30, 0)));
        }
        ...
        public void EveryDayAtTwoTimesOneLaterSameDayOneEarlierNextDay()
        {
            Assert.AreEqual(
                ...
                new Schedule(
                    new List<Clock> { new Clock { Hour = 5, Minute = 30 }, new Clock { Hour = 8, Minute = 30 } },
                    0,
                    Interval.Day)
                .Next(new DateTime(2015, 10, 05, 6, 30, 0)));
        }
